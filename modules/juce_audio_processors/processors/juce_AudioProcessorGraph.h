...
*/
    ...
    public:
        ...
        */
        ...
        public:
            ...
            */
            ...
            { 
                if (processor) //DEBUG: WHY CAN THIS GET NULLPTR
        ...
        */
        void clear(bool ignoreCallback = false);
        ...
        */
        Node::Ptr addNode (std::unique_ptr<AudioProcessor> newProcessor, bool ignoreCallback = false, NodeID nodeId = {});
        ...
        */
        ...
        Array<AudioProcessorGraph::Node*> getPreviousNodes(AudioProcessorGraph::Node* node);
        ...
        */
        bool addConnection (const Connection&, bool ignoreCallback = false);

        /** Deletes the given connection. */
        bool removeConnection (const Connection&, bool ignoreCallback = false);

        int getNodeUidBeforeSplit(AudioProcessorGraph::Node* startNode);

        AudioProcessorGraph::Node* getNodeBeforeSplit(AudioProcessorGraph::Node* startNode);

        Array<AudioProcessorGraph::Node*> getNodesAfterSplit(AudioProcessorGraph::Node * endNode);

        int numOfOutputBussesConnectedTo(AudioProcessorGraph::Node * sourceNode);

        void connectNodes(AudioProcessorGraph::Node* sourceNode, AudioProcessorGraph::Node* destNode, Array<AudioProcessorGraph::Connection> connections = {});

        void disconnectNode(AudioProcessorGraph::Node * node);
        ...
        AudioProcessorGraph::Node* getAudioInputNode();
        AudioProcessorGraph::Node* getAudioOutputNode();
        AudioProcessorGraph::Node* getDummyNode();

        AudioProcessorGraph::Node* findNodeWithProgramName(String name);
        ...
        */
        ...
        private:
            ...
            std::atomic<bool> resetBool = false;
     ...
     /*   void setEndNode(int endNode_)
        { 
            renderSequenceFloat->endNode = endNode_; 
            renderSequenceDouble->endNode = endNode_;
        }
        void setStartNode(int startNode_) {
            renderSequenceFloat->startNode = startNode_;
            renderSequenceDouble->startNode = startNode_;
            }*/

        
        //added for Mccc
        String outputBusName;
        int endNodeUid = -1;
        int startNodeUid = -1;
        bool isConnectedToMultipleNodes(Node & node_);

        Array<AudioProcessorGraph::Node*> nodesConnectedTo(Node & source);
    ...
    private:
        ...
        void topologyChanged(bool ignoreCallback = false);
        void handleAsyncUpdate() override;
        void clearRenderingSequence();
        void buildRenderingSequence();
        void setEndNode();
        bool isInputToAllOutputBusses(Node& node_);
